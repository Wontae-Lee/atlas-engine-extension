...
/** Owns the selected connection and its UI. Constructors never contact Docker. */
export class Backend implements vscode.Disposable {
	...
	/** Called by System; the initial connection is attempted once, without blocking activation. */
	update(): void {
	...
	/** Keep the current connection until the replacement has passed its native engine probe. */
